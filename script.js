    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ד\"ר איל הורוביץ משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '79048c8c-da66-45fd-9c4b-a4d4e7c2e1c9',
                    name: data.name || '',
                    email: data.email || '',
